...
class ProfilerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.LoginUser = channel.unary_unary(
                ...
                response_deserializer=gen_dot_profiler__pb2.Response.FromString,
                )
...
def add_ProfilerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'LoginUser': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=gen_dot_profiler__pb2.Response.SerializeToString,
            ),
...
class Profiler(object):
    ...
    def LoginUser(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/profiler.Profiler/LoginUser',
            ...
            gen_dot_profiler__pb2.Response.FromString,
